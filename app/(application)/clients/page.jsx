...
const UsersPage = () => {
    ...
    return (<div
        ...
        <div
            ...
            {!loading && !error && users.length > 0 ? (<div className={`w-full mt-16`}>
                <Table>
                    ...
                    {' '}
                      ...
                      >
                        ...
                        />
                                ...
                                <AlertDialog>
                                    <AlertDialogTrigger className={``}><svg
                                        xmlns='http://www.w3.org/2000/svg'
                                        fill='none'
                                        viewBox='0 0 24 24'
                                        strokeWidth={1.5}
                                    ...
                                    >
                                        ...
                                        />
                                    </svg></AlertDialogTrigger>
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                                            <AlertDialogDescription>
                                                This action cannot be undone. This will permanently delete the client's data from our servers.
                                            </AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
