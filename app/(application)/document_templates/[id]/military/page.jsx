        ...
        const fetchClientData = async () => {
            try {
                ...
                if (data?.plaintiff?.firstName && data?.defendant?.firstName) {
                    document.title = `${data.plaintiff.firstName} Vs ${data.defendant.firstName} | Military`;
                }
    ...
    return (<div className='p-4 text-xs flex flex-col min-w-screen min-h-screen w-full h-screen font-sans'>
        ...
        <div className='w-full flex justify-between items-end'>
            ...
            <div className='font-medium'>
                ...
                {clientData.defendant.fault === "No Fault" ? `NO FAULT` : `IRRECONCILABLE DIFFERENCES`}
            </div>
        </div>
            ...
            <div className='mt-8  pt-4'>
                ...
                <div className={`w-full flex justify-between font-bold`}>
                    <div className={`flex space-x-2  items-end`}>Date:
                        <div className={`w-32 h-[1px]  -mt-2 bg-black`}/>
                    </div>
