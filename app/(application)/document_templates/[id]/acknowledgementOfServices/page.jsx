...
const Page = () => {
    ...
    return (<div className='p-4 flex flex-col min-w-screen min-h-screen font-sans w-full h-screen'>
        {/* Top Section */}
        ...
        <div className='w-full flex justify-between items-center'>
            <div className='font-medium capitalize flex flex-col justify-start items-start space-y-4'>
                <div>
                    <h2>{clientData.plaintiff.firstName} {clientData.plaintiff.lastName}</h2>
                    <h2>Plaintiff</h2>
                </div>
            ...
            <div className='font-medium'>
                ...
                <h1 className='text-2xl text-center font-bold'>ACKNOWLEDGEMENT OF SERVICE</h1>
                <h1 className='text-2xl text-center font-bold'>OF SUMMONS AND COMPLAINT BY</h1>
                <h1 className='text-2xl text-center font-bold'>THE DEFENDANT AND WAIVER</h1>
